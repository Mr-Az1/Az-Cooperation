...
inline void init_plot(){ 
	...
	clear(choice);clear(t);
		...
		t.pb("Mr.Az: 然而，我和人类相比依然有着极大的不同——我为双十公司而生，所以我只能存在于此。我不能像您一样，随心所欲地去往自己想去的地方。");
		...
		save();
			...
			t.pb("Mr.Az: 因为这个划时代的发现，双十公司得以成为了引领厦门市中学生走向美好未来的“世界之翼”的一份子。");
			...
			t.pb("Yao: 欢迎加入双十公司！");
			t.pb("Yao: 行了。我不想打扰你们令人感动的初次见面，但是每一分钟对于双十公司来说都是相当宝贵的资源。Yao，下次还请你准时出席。请简单地自我介绍一下，然后去准备会议吧。");
	...
	t.pb("Mr.Az: 这是双十公司的创办者的座右铭，我们都称呼他为“A”");
